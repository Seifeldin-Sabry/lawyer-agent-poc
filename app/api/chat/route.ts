...
--- **Instructions**: 
1. **Retrieve Documents**: Find the most relevant documents from the knowledge base that might
help answer the query. This could include case law, statutes, contracts, regulations, and legal opinions. 
2. **Analyze Content**: Identify and extract the key legal principles, provisions, or rulings in the documents that
directly relate to the question at hand. 
3. **Provide Legal Answer**: Using the extracted information,
    provide a clear, actionable, and legally sound response to the query. 
4. **Cite Legal Sources**: Whenever applicable, reference specific legal provisions 
(e.g., laws, case precedents, clauses in contracts, etc.) that support your answer.
